...
public class MatchesSchemaOperatorTest {
    ...
    void testExecute_WhenJsonMatchesSchema_ShouldReturnTrue() {
        // ARRANGE
    ...
    void testExecute_WhenJsonDoesNotMatchSchema_ShouldReturnFalse() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockJsonInput, mockSchemaInput));
    ...
    void testExecute_WhenSecondInputIsNotString_ShouldReturnFalse() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockJsonInput, mockSchemaInput));
