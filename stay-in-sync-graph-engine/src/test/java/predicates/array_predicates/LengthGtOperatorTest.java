...
import de.unistuttgart.graphengine.logic_operator.array_predicates.LengthGtOperator;
...
/**
 * Unit tests for the LengthGtOperator.
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("Operation: ARRAY_LENGTH_GT")
public class LengthGtOperatorTest {

    private LengthGtOperator operation;
    ...
    @BeforeEach
    void setUp() {
        operation = new LengthGtOperator();
    }

    // ===== BASIC FUNCTIONALITY TESTS =====

    @Test
    @DisplayName("should return true if array length is greater than expected")
    ...
    @Test
    @DisplayName("should return false if array length is less than expected")
    void testExecute_WhenLengthIsLess_ShouldReturnFalse() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockLengthInput));
    ...
    @Test
    @DisplayName("should return true when array length is one more than expected")
    void testExecute_WhenLengthIsOneBigger_ShouldReturnTrue() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockLengthInput));
        when(mockArrayInput.getCalculatedResult()).thenReturn(List.of("a", "b", "c", "d")); // Länge 4
        when(mockLengthInput.getCalculatedResult()).thenReturn(3);
    ...
    @Test
    @DisplayName("should return true when single element collection compared to zero")
    void testExecute_WhenSingleElementAndZero_ShouldReturnTrue() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockLengthInput));
        ...
        // ASSERT
        assertTrue((Boolean) result); // 1 > 0 ist true
    }
    ...
    void testExecute_WithPrimitiveIntArray_ShouldWork() {
        ...
        // ASSERT
        assertTrue((Boolean) result); // 3 > 2
    }

    @Test
    @DisplayName("should return false for primitive array when not greater")
    void testExecute_WithPrimitiveArrayNotGreater_ShouldReturnFalse() {
        // ARRANGE
        ...
        // ASSERT
        assertFalse((Boolean) result); // 2 > 2 ist false
    }
    ...
    void testExecute_WithHashSet_ShouldWork() {
        ...
        // ASSERT
        assertFalse((Boolean) result); // 2 > 3 ist false
    }
    ...
    void testExecute_WithDoubleLength_ShouldWork() {
        ...
        when(mockLengthInput.getCalculatedResult()).thenReturn(2.0); // Double

        // ACT
        Object result = operation.execute(mockLogicNode, null);

        // ASSERT
        assertTrue((Boolean) result); // 4 > 2
    }
    ...
    void testExecute_WithFloatLength_ShouldWork() {
        ...
        when(mockLengthInput.getCalculatedResult()).thenReturn(3.0f); // Float
    ...
    void testExecute_WithLongLength_ShouldWork() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockLengthInput));
        when(mockArrayInput.getCalculatedResult()).thenReturn(List.of("a", "b", "c", "d", "e"));
    ...
    void testExecute_WithNegativeLength_ShouldReturnTrue() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockLengthInput));
        ...
        // ASSERT
        assertTrue((Boolean) result); // 3 > -1
    }

    @Test
    @DisplayName("should handle zero expected length with non-empty array")
    void testExecute_WithZeroLengthNonEmptyArray_ShouldReturnTrue() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockLengthInput));
        when(mockArrayInput.getCalculatedResult()).thenReturn(List.of("a", "b", "c"));
        when(mockLengthInput.getCalculatedResult()).thenReturn(0);
        ...
        // ASSERT
        assertTrue((Boolean) result); // 3 > 0
    }

    @Test
    @DisplayName("should return false when empty array compared to negative")
    void testExecute_WithEmptyArrayAndNegative_ShouldReturnTrue() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockLengthInput));
    ...
    void testExecute_WithLargeCollection_ShouldWork() {
        ...
        when(mockLengthInput.getCalculatedResult()).thenReturn(500);

        // ACT
        Object result = operation.execute(mockLogicNode, null);

        // ASSERT
        assertTrue((Boolean) result); // 1000 > 500
    }
    ...
    void testExecute_WithVeryLargeExpectedLength_ShouldReturnFalse() {
        ...
        // ASSERT
        assertFalse((Boolean) result); // 3 > MAX_VALUE ist false
    }

    @Test
    @DisplayName("should handle maximum integer boundaries")
    void testExecute_WithMaxIntBoundary_ShouldWork() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockLengthInput));
        when(mockArrayInput.getCalculatedResult()).thenReturn(List.of("a", "b"));
        ...
        // ASSERT
        assertTrue((Boolean) result); // 2 > MIN_VALUE
    }
