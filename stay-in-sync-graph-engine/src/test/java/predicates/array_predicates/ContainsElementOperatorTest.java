...
import de.unistuttgart.graphengine.logic_operator.array_predicates.ContainsElementOperator;
...
/**
 * Unit tests for the ContainsElementOperator.
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("Operation: CONTAINS_ELEMENT")
public class ContainsElementOperatorTest {

    private ContainsElementOperator operation;
    ...
    @BeforeEach
    void setUp() {
        operation = new ContainsElementOperator();
    }

    // ===== BASIC FUNCTIONALITY TESTS =====

    @Test
    @DisplayName("should return true if the array contains the element")
    void testExecute_WhenArrayContainsElement_ShouldReturnTrue() {
        // ARRANGE
    ...
    @Test
    @DisplayName("should return false if the array does not contain the element")
    void testExecute_WhenArrayDoesNotContainElement_ShouldReturnFalse() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockElementInput));
        when(mockArrayInput.getCalculatedResult()).thenReturn(List.of("a", "b", "c"));
    ...
    @Test
    @DisplayName("should return true when element is at first position")
    void testExecute_WhenElementIsFirst_ShouldReturnTrue() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockElementInput));
    ...
    @Test
    @DisplayName("should return true when element is at last position")
    void testExecute_WhenElementIsLast_ShouldReturnTrue() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockElementInput));
    ...
    @Test
    @DisplayName("should return false when searching for null in collection without null")
    void testExecute_WhenSearchingForNullNotPresent_ShouldReturnFalse() {
        // ARRANGE
    ...
    void testExecute_WithIntegerArray_ShouldWork() {
        ...
        when(mockElementInput.getCalculatedResult()).thenReturn(3);
    ...
    @Test
    @DisplayName("should return false when element not in primitive array")
    void testExecute_WithPrimitiveArrayNoMatch_ShouldReturnFalse() {
        // ARRANGE
        int[] primitiveArray = {10, 20, 30, 40};
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockElementInput));
        when(mockArrayInput.getCalculatedResult()).thenReturn(primitiveArray);
    ...
    void testExecute_WithEmptyArray_ShouldReturnFalse() {
        // ARRANGE
        String[] emptyArray = {};
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockElementInput));
    ...
    void testExecute_WithArrayList_ShouldWork() {
        ...
        when(mockElementInput.getCalculatedResult()).thenReturn("y");
    ...
    void testExecute_WithEmptyCollection_ShouldReturnFalse() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockElementInput));
    ...
    void testExecute_WithStringTypeMatching_ShouldWork() {
        ...
        when(mockElementInput.getCalculatedResult()).thenReturn("2");
    ...
    void testExecute_WithTypeMismatch_ShouldReturnFalse() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockArrayInput, mockElementInput));
        when(mockArrayInput.getCalculatedResult()).thenReturn(List.of("1", "2", "3"));
    ...
    void testValidateNode_WithIncorrectInputCount_ShouldThrowException() {
        ...
        assertTrue(exception.getMessage().contains("CONTAINS_ELEMENT"));
    }
