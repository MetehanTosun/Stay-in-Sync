...
import de.unistuttgart.graphengine.logic_operator.string_predicates.StringNotContainsOperator;
...
/**
 * Unit tests for the StringNotContainsOperator.
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("Operation: STRING_NOT_CONTAINS")
public class StringNotContainsOperatorTest {

    private StringNotContainsOperator operation;
    ...
    @BeforeEach
    void setUp() {
        operation = new StringNotContainsOperator();
    }

    @Test
    @DisplayName("should return true if the first string does not contain the second")
    void testExecute_WhenStringDoesNotContainSubstring_ShouldReturnTrue() {
        // ARRANGE
    ...
    @Test
    @DisplayName("should return false if the first string contains the second")
    void testExecute_WhenStringContainsSubstring_ShouldReturnFalse() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockInputNode1, mockInputNode2));
