...
public class NotBetweenOperatorTest {
    ...
    void testExecute_WithIntegerTypes_ShouldWork() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockValueNode, mockLowerBoundNode, mockUpperBoundNode));
        when(mockValueNode.getCalculatedResult()).thenReturn(5); // Outside bounds
    ...
    void testExecute_WithLongTypes_ShouldWork() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockValueNode, mockLowerBoundNode, mockUpperBoundNode));
        when(mockValueNode.getCalculatedResult()).thenReturn(25L); // Outside bounds
    ...
    void testExecute_WithFloatTypes_ShouldWork() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockValueNode, mockLowerBoundNode, mockUpperBoundNode));
        when(mockValueNode.getCalculatedResult()).thenReturn(5.5f); // Outside bounds
    ...
    void testExecute_WithMixedNumberTypes_ShouldWork() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockValueNode, mockLowerBoundNode, mockUpperBoundNode));
        when(mockValueNode.getCalculatedResult()).thenReturn(25.0); // Double, outside bounds
    ...
    @Test
    @DisplayName("should return false when Integer value is inside bounds")
    void testExecute_WithIntegerValueInside_ShouldReturnFalse() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockValueNode, mockLowerBoundNode, mockUpperBoundNode));
        when(mockValueNode.getCalculatedResult()).thenReturn(15); // Inside bounds
        when(mockLowerBoundNode.getCalculatedResult()).thenReturn(10);
        when(mockUpperBoundNode.getCalculatedResult()).thenReturn(20);
