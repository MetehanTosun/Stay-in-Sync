...
import de.unistuttgart.graphengine.logic_operator.number_predicates.LessThanOperator;
...
/**
 * Unit tests for the LessThanOperator.
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("Operation: LESS_THAN")
public class LessThanOperatorTest {

    private LessThanOperator operation;
    ...
    @BeforeEach
    void setUp() {
        operation = new LessThanOperator();
    }
