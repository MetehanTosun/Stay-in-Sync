...
import de.unistuttgart.graphengine.logic_operator.number_predicates.LessOrEqualOperator;
...
/**
 * Unit tests for the LessOrEqualOperator.
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("Operation: LESS_OR_EQUAL")
public class LessOrEqualOperatorTest {

    private LessOrEqualOperator operation;
    ...
    @BeforeEach
    void setUp() {
        operation = new LessOrEqualOperator();
    }

    @Test
    @DisplayName("should return true if first value is less than second")
    void testExecute_WhenFirstIsLess_ShouldReturnTrue() {
        // ARRANGE
    ...
    void testExecute_WhenValuesAreEqual_ShouldReturnTrue() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockInputNode1, mockInputNode2));
    ...
    @Test
    @DisplayName("should return false if first value is greater than second")
    void testExecute_WhenFirstIsGreater_ShouldReturnFalse() {
        // ARRANGE
        when(mockLogicNode.getInputNodes()).thenReturn(List.of(mockInputNode1, mockInputNode2));
        when(mockInputNode1.getCalculatedResult()).thenReturn(15.0);
        when(mockInputNode2.getCalculatedResult()).thenReturn(10.0);
