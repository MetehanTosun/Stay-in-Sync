...
class SnapshotServiceTest {
    ...
    void getById_shouldReturnSnapshot() {
        ...
        when(syncNodeClient.getById("123")).thenReturn(snapshot);
        ...
        verify(syncNodeClient).getById("123");
    }

    @Test
    void getById_shouldReturnNullOnError() {
        // Arrange
        when(syncNodeClient.getById("123")).thenThrow(new RuntimeException("not found"));
