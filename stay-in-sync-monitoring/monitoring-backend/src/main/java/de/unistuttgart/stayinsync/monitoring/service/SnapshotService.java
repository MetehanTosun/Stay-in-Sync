 ...
 * synchronization nodes responsible for storing and managing transformation
 * snapshots.
 * It provides methods to fetch the latest snapshot, the last five snapshots, or
 * a snapshot by ID.
 * </p>
 * <p>
...
public class SnapshotService {
     ...
     *
     * @param transformationId the ID of the transformation
     * @return a list of up to five {@link SnapshotDTO} objects, or an empty list if
     *         the fetch fails
     */
