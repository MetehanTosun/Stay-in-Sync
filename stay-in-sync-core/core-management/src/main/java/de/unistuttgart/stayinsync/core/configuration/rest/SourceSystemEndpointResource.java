...
@Path("api/source-system-endpoint")
...
public class SourceSystemEndpointResource {
    ...
    public Response createSourceSystemEndpoint(
        ...
        var persistedSourceSystemEndpoint = this.sourceSystemEndpointService.persistSourceSystemEndpoint(fullUpdateMapper.mapToEntity(SourceSystemEndpointDTO));
    ...
    public Response getSourceSystemEndpoint(@Parameter(name = "id", required = true) @PathParam("id") Long id) {
        return this.sourceSystemEndpointService.findSourceSystemEndpointById(id)
                ...
                .orElseThrow(() -> {
                    ...
                    return new CoreManagementWebException(Response.Status.NOT_FOUND, "Unable to find source-system-endpoint", "No source-system-endpoint found using id %d", id);
                });
    }
