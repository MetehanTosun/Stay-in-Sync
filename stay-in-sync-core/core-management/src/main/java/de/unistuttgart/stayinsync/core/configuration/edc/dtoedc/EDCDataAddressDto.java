...
public class EDCDataAddressDto {
    ...
    private Long id;
    @NotBlank private String jsonLDType;
    @NotBlank private String type;
    @NotBlank private String baseURL;
    @NotNull  private Boolean proxyPath;
    @NotNull  private Boolean proxyQueryParams;

    public Long getId() { return id; }
    public EDCDataAddressDto setId(Long id) {
        this.id = id; 
        return this;
    }

    public String getJsonLDType() { return jsonLDType; }
    ...
    public Boolean getProxyPath() { return proxyPath; }
    public EDCDataAddressDto setProxyPath(Boolean proxyPath) {
        this.proxyPath = proxyPath; 
        return this;
    }

    public Boolean getProxyQueryParams() { return proxyQueryParams; }
