...
public class LessOrEqualOperator extends AbstractNumericComparisonOperator {

    /**
     * Compares two numbers to determine if the first is less than or equal to the second.
     *
