...
import de.unistuttgart.stayinsync.transport.transformation_rule_shared.nodes.SnapshotEntry;
...
public class LogicGraphEvaluator {
     ...
     * @param job             The context of the transformation job, used for creating debug snapshots on failure.
     ...
     */
    public EvaluationResult evaluateGraph(List<Node> allNodesInGraph, Map<String, JsonNode> dataContext, TransformJob job)
