...
public class StringLengthGtOperator extends AbstractStringLengthComparisonOperator {

    /**
     * Checks if the string's length is greater than the given numeric value.
     * @param length The actual length of the input string.
     * @param value  The numeric value to compare against.
     * @return {@code true} if the length is greater than the value.
     */
    @Override
